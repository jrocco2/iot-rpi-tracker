...
if __name__ == '__main__':
  ...
  try:
    ...
    while True:
      ...
      print 'lat ' , gpsd.fix.latitude, 'long ' , gpsd.fix.longitude, 'time utc' , gpsd.utc,' + ', gpsd.fix.time, 
      'altitude (m)' , gpsd.fix.altitude,'eps ' , gpsd.fix.eps,'epx ' , gpsd.fix.epx,'epv ' ,
      gpsd.fix.epv,'ept ' , gpsd.fix.ept,'speed (m/s) ' , gpsd.fix.speed,'climb ' , gpsd.fix.climb,'track ' , 
